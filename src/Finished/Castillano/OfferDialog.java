...
public class OfferDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnBeginning.setBackground(new java.awt.Color(107, 30, 35));
        btnBeginning.setFont(new java.awt.Font("Gloucester MT Extra Condensed", 1, 14)); // NOI18N
        ...
        btnEnd.setBackground(new java.awt.Color(107, 30, 35));
        btnEnd.setFont(new java.awt.Font("Gloucester MT Extra Condensed", 1, 14)); // NOI18N
        ...
        btnCancel.setBackground(new java.awt.Color(107, 30, 35));
        btnCancel.setFont(new java.awt.Font("Gloucester MT Extra Condensed", 1, 14)); // NOI18N

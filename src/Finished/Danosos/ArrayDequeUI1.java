...
public class ArrayDequeUI1 extends javax.swing.JFrame {
    ...
    // Offer Dialog for the option to pick which will trigger the offer fuction
    ...
    public ArrayDequeUI1() {
        ...
        offerDialog = new OfferDialog(this, true); // Creates an popup window for the offer option
    ...
    // This method runs when the "Offer" button is clicked
        private void btnOfferActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOfferActionPerformed
            ...
            if (str.isBlank()) {
                showMessageDialog("Please enter a data.");
                return;
            }
            ...
            try {
                data = Integer.parseInt(str);     // Convert the text from str into an integer
            ...
            switch (offerDialog.getOfferType()) {
                case "FIRST" -> {
                    arrayDeque.offerFirst(data); // Add the number at first to the ArrayDeque
                }
                case "LAST" -> {
                    arrayDeque.offerLast(data); // Add the number at last to the ArrayDeque
                }
                default -> {
                    return;
                }

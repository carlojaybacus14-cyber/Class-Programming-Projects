...
public class StackFrame extends javax.swing.JFrame {
        ...
        private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(StackFrame.class.getName());
    ...
    private void initComponents() {
        ...
        btnPush.setBackground(new java.awt.Color(10, 56, 64));
        btnPush.setFont(new java.awt.Font("Rajdhani Medium", 1, 16)); // NOI18N
        btnPush.setForeground(new java.awt.Color(34, 211, 238));
        btnPush.setText("Push");

        btnPop.setBackground(new java.awt.Color(10, 56, 64));
        btnPop.setFont(new java.awt.Font("Rajdhani Medium", 1, 16)); // NOI18N
        btnPop.setForeground(new java.awt.Color(34, 211, 238));
        btnPop.setText("Pop");

        btnPeek.setBackground(new java.awt.Color(10, 56, 64));
        btnPeek.setFont(new java.awt.Font("Rajdhani Medium", 1, 16)); // NOI18N
        btnPeek.setForeground(new java.awt.Color(34, 211, 238));
        btnPeek.setText("Peek");

        btnEmpty.setBackground(new java.awt.Color(10, 56, 64));
        btnEmpty.setFont(new java.awt.Font("Rajdhani Medium", 1, 16)); // NOI18N
        btnEmpty.setForeground(new java.awt.Color(34, 211, 238));
         ...
         * For details see http://download.oracle.com/javase/tutorial/uiswing/lookandfeel/plaf.html 
                ...
                java.awt.EventQueue.invokeLater(() -> new StackFrame().setVisible(true));
        }
